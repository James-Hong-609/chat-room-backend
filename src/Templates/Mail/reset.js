export default (name, reset) => {
  ...
  <html lang="en">
    ...
    <body>
      <div class="container">
        <div class="header">Welcome to PengyOS</div>
        <div class="logo">
          <a href="https://chat.madhaoqi.eu.org/">
            <img src="https://i.imgur.com/KZkoFRO.png" alt="PengyOS Logo" />
          </a>
        </div>
      ...
      <div class="footer">
        ...
        <p>
          ...
          <a href="mailto:jameshero609@gmail.com">jameshero609@gmail.com</a>.
        </p>
      </div>
    </body>
  </html>
